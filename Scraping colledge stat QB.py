...
combine2020 = pd.read_csv(r'D:\EARTH\NIDA\NFL Project\Project-NFL-BADS6001\combine 2020.csv',encoding= 'UTF-8')
...
train_df.to_csv(r'D:\EARTH\NIDA\NFL Project\Project-NFL-BADS6001\QB_college stats.csv', index = False)
qb1 = combine["Pos"].isin(["QB"])
position_QB1 = combine[qb1]
position_QB1.to_csv(r'D:\EARTH\NIDA\NFL Project\Project-NFL-BADS6001\NameQB.csv', index = False)

#test data
test = scrap_college(combine2020)
test_df = concat(test)
test_df.to_csv(r'D:\EARTH\NIDA\NFL Project\Project-NFL-BADS6001\QB_college stats(test).csv', index = False)
qb2 = combine2020["Pos"].isin(["QB"])
position_QB2 = combine2020[qb2]
position_QB2.to_csv(r'D:\EARTH\NIDA\NFL Project\Project-NFL-BADS6001\NameQB(test).csv', index = False)